...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	    var animation = __webpack_require__(2).owlAnim;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.owlAnim = {
	    ...
	    transition: function transition(array) {
	        this.owlyFly(this.owly);
	        $.each(array, function (i, val) {
	            $('.' + val).addClass('transition');
	        });
	    },
	    init: function init() {
	        this.transition(this.bgarray);
	    }
